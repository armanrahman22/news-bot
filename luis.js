...
function getLuisResults(utterance) {
    return __awaiter(this, void 0, void 0, function () {
        var endpoint, luisAppId, queryParams, luisRequest, response, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    luisRequest = endpoint + luisAppId +
                        '?' + querystring.stringify(queryParams);
                    return [4 /*yield*/, fetch(luisRequest)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                    return [2 /*return*/, { topScoringIntent: data.topScoringIntent, intents: data.intents, entities: data.entities }];
            }
        });
    });
}
